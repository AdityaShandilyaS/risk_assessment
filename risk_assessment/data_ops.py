...
class MLModule:
    ...
    def analyse_dataset(self):
        ...
        folder_path = os.path.join(self.fileops.main_dir, 'risk_assessment/inferencedata')
        plt.savefig(folder_path + '/' + str(timestamp) + '_scatterplot.png')
    ...
    def train_decision_tree_model(self, splitter='best', max_depth=None, min_samples_split=2):
        if max_depth:
            ...
            md = max_depth
        clf_model = DecisionTreeClassifier(splitter=splitter, max_depth=md,
